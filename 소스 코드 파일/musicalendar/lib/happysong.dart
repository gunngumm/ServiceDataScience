...
class happysong extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'My App',
      home: _happysong(), // finals 데이터는 필요에 맞게 전달해야 합니다.
    );
  }
}


class _happysong extends StatefulWidget {
  @override
  _happysongState createState() => _happysongState();
}

class _happysongState extends State<_happysong> {
  ...
  Future<void> loadAsset() async {
    final myData = await rootBundle.loadString('assets/result_positive.csv');
