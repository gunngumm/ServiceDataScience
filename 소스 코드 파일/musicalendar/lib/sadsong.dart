...
class sadsong extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'My App',
      home: _sadsong(), // finals 데이터는 필요에 맞게 전달해야 합니다.
    );
  }
}


class _sadsong extends StatefulWidget {
  @override
  _sadsongState createState() => _sadsongState();
}

class _sadsongState extends State<_sadsong> {
  ...
  Future<void> loadAsset() async {
    final myData = await rootBundle.loadString('assets/result_mood.csv');
