...
class boringsong extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'My App',
      home: _boringsong(), // finals 데이터는 필요에 맞게 전달해야 합니다.
    );
  }
}


class _boringsong extends StatefulWidget {
  @override
  _boringsongState createState() => _boringsongState();
}

class _boringsongState extends State<_boringsong> {
  ...
  Future<void> loadAsset() async {
    final myData = await rootBundle.loadString('assets/result_neutral.csv');
